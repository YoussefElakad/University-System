...
@Service
public class CourseServ extends BaseCRUDServices<Course,Long>
{
    ...
    public CourseServ(CourseRep repc, FacultyRep repf, LevelRep repl, DoctorRep repd, StudentRep reps, UsersRep repu, GradesRep repg, CourseMapper mapper) {
        super(repc);
        this.repc = repc;
        this.repf = repf;
        this.repl = repl;
    ...
    {
        return getPages(page,size,"courseid",mapper::toDTO);
    }
